...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
//About the Laser feature:
//we just use FAN1 PIN to control the PWM singnal of laser engine, and set the
//PWM duration by 
//
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
//Titan Extruder
...
Description:
  ...
  Hardware:
  	...
  	Z2 ENDSTOP: 
  	for ZRIB control board, the 2st ENDSTOP connect to Y-MAX pin
  	for ZM3E4 control board, the 2st ENDSTOP connect to Z2- pin(PD1)
*/
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
/*
Description:
  Defaulf Z9 use a proximity sensor PL-08N as a bed leveling sensor, if you upgrade it
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ZONESTAR_ZM3E4
#endif
...
#define MIXING_EXTRUDER
  ...
  #endif
  #define MIXING_ZPOS_CURRENT_VALUE 	0
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 169.18
  #define DEFAULT_bedKi 28.91
  #define DEFAULT_bedKd 660.02
...
#if BOTH(OPTION_TMC220X_EXTRUDER, OPTION_TITAN)||NONE(OPTION_TMC220X_EXTRUDER, OPTION_TITAN)
